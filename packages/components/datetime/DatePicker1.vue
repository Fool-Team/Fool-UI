  ...
  <div style="display: inline-block">
    ...
    <div class="date-picker" v-show="isShow" style="width: 220px">
              ...
              <td
                ...
                :class="[
                  new Date(monthList[idx - 1][m - 1]).getMonth() + 1 == month
                    ? ''
                    : 'gray',
                  getSelectDate(monthList[idx - 1][m - 1]) ? 'active' : ''
                ]"
      ...
      <div class="picker-footer">
        <!-- <fool-button @click="onFullMonth" class="mybutton">整月</fool-button>
        <fool-button
          @click="
            onSelectDate(
              new Date(new Date().format('yyyy-MM-dd 00:00')).getTime()
            )
          "
          class="mybutton"
        >
        ...
        <fool-button @click="closePicker" class="mybutton">关闭</fool-button> -->
      </div>
    </div>
  </div>
</template>
